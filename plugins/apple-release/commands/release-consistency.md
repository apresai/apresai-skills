...
`/chad-review`; fix CRITICAL/HIGH before merge, file MEDIUM/LOW to backlog. Squash-merge.
...
- One PR per repo via worktree branch → push → `gh pr create` → `/chad-review` → squash-merge.
